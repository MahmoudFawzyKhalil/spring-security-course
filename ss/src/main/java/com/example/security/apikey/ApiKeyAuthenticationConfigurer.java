...
public class ApiKeyAuthenticationConfigurer extends AbstractHttpConfigurer<ApiKeyAuthenticationConfigurer, HttpSecurity> {
    ...
    public void configure(HttpSecurity http) {
        ...
        CustomApiKeyAuthenticationFilter apiKeyAuthenticationFilter = new CustomApiKeyAuthenticationFilter(authenticationManager, new ApiKeyAuthenticationConverter());
